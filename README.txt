...
Для начала пользователь использует команду /subscribe, которая подписывает чего,
если пользователь больше не хочет получть новые новости, он испоьзует команду /unsubscribe.
